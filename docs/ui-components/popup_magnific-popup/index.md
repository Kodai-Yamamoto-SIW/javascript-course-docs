...
ベースは jQuery となるため、jQuery の基本的な扱いは、[以前 jQuery を学習した際の内容](../accordion-menu_jquery-slidetoggle/index.md)を思い出してみてください。
...
<CodePreview
  ...
  images={{
    "img/christmas_chicken.jpg": require("./img/christmas_chicken.jpg")
  }}
/>
...
<CodePreview
  ...
  images={{
    "img/christmas_chicken.jpg": require("./img/christmas_chicken.jpg"),
    "img/christmas_snowman.jpg": require("./img/christmas_snowman.jpg"),
    "img/whole_cake.jpg": require("./img/whole_cake.jpg")
  }}
/>
