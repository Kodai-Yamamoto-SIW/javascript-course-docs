...
<Exercise title="演習4-発展（お気に入りボタン）">
...
<Exercise title="演習6-発展（画像ギャラリー切り替え）">
...
<Exercise title="演習7-発展（プライスカード選択）">
